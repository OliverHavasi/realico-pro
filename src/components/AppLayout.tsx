...
function SidebarToggle() {
  ...
  return (
    <button
      ...
      className="fixed top-1/2 -translate-y-1/2 z-50 h-7 w-7 rounded-full bg-primary text-primary-foreground flex items-center justify-center shadow-primary hover:scale-110 transition-transform"
      style={{
        ...
        <div className="flex-1 flex flex-col min-w-0">
          <header className="h-16 flex items-center justify-between px-8 sticky top-0 z-30">
            <div className="flex items-center gap-3">
              <div className="hidden md:flex items-center gap-2 bg-secondary rounded-full px-5 h-[var(--interactive-height)]">
