    ...
    <div className="glass-card p-6">
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 xl:grid-cols-4 gap-4 md:gap-[var(--spacing-uniform)] lg:gap-[var(--spacing-lg)]">
        {properties.map((property) => (
          <div
            key={property.title}
            className="bg-secondary rounded-[var(--radius)] p-4 transition-all duration-300 ease-out hover:scale-[1.02] hover:shadow-2xl hover:-translate-y-1 cursor-pointer"
          >
